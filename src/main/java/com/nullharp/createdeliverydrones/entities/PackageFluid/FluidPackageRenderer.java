...
public class FluidPackageRenderer  extends EntityRenderer<FluidPackageEntity> {

    public FluidPackageRenderer(Context pContext) {
        super(pContext);
        shadowRadius = 0.5f;
    }

    @Override
    public void render(FluidPackageEntity entity, float yaw, float pt, PoseStack ms, MultiBufferSource buffer, int light) {
    ...
    @Override
    public ResourceLocation getTextureLocation(FluidPackageEntity pEntity) {
        return null;
    }
