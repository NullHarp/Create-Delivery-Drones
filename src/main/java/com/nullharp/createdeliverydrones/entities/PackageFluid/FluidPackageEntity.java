...
public class FluidPackageEntity extends LivingEntity implements IEntityAdditionalSpawnData {
    ...
    public FluidPackageEntity(EntityType<?> entityTypeIn, Level worldIn) {
